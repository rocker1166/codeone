...
export default function Home() {
  ...
  const [showMore, setShowMore] = useState(false); // State to toggle file visibility
          ...
          {files.length > 0 && (
            <div className="mt-6">
              ...
              <ul className="mt-2 border border-gray-200 rounded-md divide-y divide-gray-200">
                {files.slice(0, showMore ? files.length : 5).map((file, index) => (
              ...
              {files.length > 5 && (
                <Button variant="outline" className="mt-2" onClick={toggleShowMore}>
